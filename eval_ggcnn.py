...
MODEL_PATH = Path.home().joinpath('Project/gmdata/datasets/models/gg2/shahao_model')
TRAINSET = "gmd"
...
def parse_args():
    ...
    # Network
    parser.add_argument('--network', type=str, default=MODEL_PATH,help='Path to saved network to evaluate')
    parser.add_argument('--train-set', type=str, default=TRAINSET,help='Path to saved network to evaluate')
...
if __name__ == '__main__':
    ...
    # Load Network
    model_path = get_model(args.network+args.train_set)
